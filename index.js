...
client.on("message", async message =>{
    ...
    var regel1 =  dashboard.getVal(message.guild.id, "Regel1");
    var regel2 =  dashboard.getVal(message.guild.id, "Regel2");
    var regel3 =  dashboard.getVal(message.guild.id, "Regel3");
    var regel4 =  dashboard.getVal(message.guild.id, "Regel4");
    var regel5 =  dashboard.getVal(message.guild.id, "Regel5");
    var regel6 =  dashboard.getVal(message.guild.id, "Regel6");
    var regel7 =  dashboard.getVal(message.guild.id, "Regel7");
    var regel8 =  dashboard.getVal(message.guild.id, "Regel8");
    var regel9 =  dashboard.getVal(message.guild.id, "Regel9");
    var regel10 =  dashboard.getVal(message.guild.id, "Regel10");
    var regel11 =  dashboard.getVal(message.guild.id, "Regel11");
    var regel12 =  dashboard.getVal(message.guild.id, "Regel12");
    var regel13 =  dashboard.getVal(message.guild.id, "Regel13");
    var regel14 =  dashboard.getVal(message.guild.id, "Regel14");
    var regel15 =  dashboard.getVal(message.guild.id, "Regel15");
